...
> Task ID: `tsk-023-23` | Project: `prj-023` | Status: doing
...
- [ ] TaskForm.tsx Preview 모드 수정 (notes || _body fallback)
- [ ] TaskForm.tsx Edit 모드 defaultValue에 fallback 추가 (Codex 피드백)
- [ ] TaskForm.tsx onBlur에 변경 감지 가드 추가 (Codex 피드백)
- [ ] 빌드 테스트 (npm run build)
- [ ] tsk-023-09 열어서 body 내용 표시 확인
- [ ] Edit → Preview 전환 시 데이터 유지 확인
