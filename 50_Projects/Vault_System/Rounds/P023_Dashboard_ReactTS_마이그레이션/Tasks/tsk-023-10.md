...
- [ ] Step 1: useKeyboardShortcuts 훅 생성 (`src/hooks/useKeyboardShortcuts.ts`)
- [ ] Step 2: HelpModal 컴포넌트 생성 (`src/components/common/HelpModal.tsx`)
- [ ] Step 3: AppLayout에 훅 연결 + HelpModal 추가
- [ ] Step 4: FilterProvider를 AppLayout으로 이동
- [ ] Step 5: KanbanPage에서 FilterProvider 제거
- [ ] Step 6: 검증 - 각 단축키 동작 테스트
