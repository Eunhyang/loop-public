...
> Task ID: `tsk-023-13` | Project: `prj-023` | Status: done
...
#### 2026-01-08
**개요**: Task 완료 - 캘린더 필터 통합 구현

**구현 내용**:
- useUrlFilters에 projectIds, toggleProjectId, setProjectIds 추가
- KanbanFilters를 TaskFilterBar로 이동하여 공용 컴포넌트화
- 칸반 페이지를 useUrlFilters + TaskFilterBar로 전환
- useKanbanFilters 제거
- 캘린더 페이지에 TaskFilterBar 추가
- useCalendarEvents에 필터링 로직 추가 (assignee, projectIds, programId)
- 칸반 ↔ 캘린더 뷰 전환 시 필터 상태 유지 확인
