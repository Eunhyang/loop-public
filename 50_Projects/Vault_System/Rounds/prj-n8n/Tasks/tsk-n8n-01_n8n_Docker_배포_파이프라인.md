...
notes: "# n8n Docker 배포 및 파이프라인 구축\n\n> Task ID: `tsk-n8n-01` | Project: `prj-n8n`\
  ...
  ---\n\n## 상세 내용\n\n### 배경\n\nTask/Project 엔티티에 빠진 필드를 수동으로 채우는 것은 비효율적. n8n + LLM으로\
