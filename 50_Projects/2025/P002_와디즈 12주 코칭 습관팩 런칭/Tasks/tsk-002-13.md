...
### Todo
- [ ] Step 1: promotions.ts - Tx#1 Reserve (pending 상태 생성)
- [ ] Step 2: promotions.ts - RevenueCat API 호출 로직 수정
- [ ] Step 3: promotions.ts - Tx#2 Finalize (success/failed)
- [ ] Step 4: checkPromoCode - 읽기 로직 v2 우선, v1 폴백
