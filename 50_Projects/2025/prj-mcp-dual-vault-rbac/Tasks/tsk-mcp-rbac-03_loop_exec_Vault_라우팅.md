...
notes: "# MCP - loop_exec Vault 라우팅 구현\n\n> Task ID: `tsk-mcp-rbac-03` | Project:\
  ...
  3. [admin@sosilab.com](mailto:admin@sosilab.com) 계정 role이 `admin`으로 설정됨\n4. Docker\
  \ compose - loop_exec 볼륨 마운트 추가\n5. ChatGPT MCP에서 `exec/` 경로 접근 테스트 통과\n\n---\n\n\
