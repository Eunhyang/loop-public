...
# === 분류 ===
tags: ["content-os", "mvp", "infrastructure", "automation"]
priority_flag: high
---

# Content OS - MVP 개발

> Project ID: `prj-018` | Track: `trk-3` | Program: `pgm-content-os` | Status: active
...
|----|------|----------|--------|-----|
| tsk-018-01 | Content OS - 프로젝트 초기 세팅 | 김은향 | doing | |
| tsk-018-02 | Content OS - Opportunity 대시보드 UI | 김은향 | todo | |
| tsk-018-03 | Content OS - Video Explorer UI | 김은향 | todo | |
| tsk-018-04 | Content OS - Task Pipeline UI | 김은향 | todo | |
| tsk-018-05 | Content OS - 회고 대시보드 UI | 김은향 | todo | |
...
**문제 정의**:
콘텐츠 기획/실행/회고가 분리되어 있어 학습이 축적되지 않음

**목표**:
시장 신호 + 우리 채널 Analytics를 결합한 콘텐츠 태스크 자동 생성 시스템
