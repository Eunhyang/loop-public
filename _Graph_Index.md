...
| `prj-017` | 아이디어파트너스 배치 프로그램 지원 | todo | `50_Projects/TIPS_Batch/Rounds/prj-017_아이디어파트너스_배치/Project_정의.md` |
| `prj-018` | 프라이머 배치 프로그램 지원 | todo | `50_Projects/TIPS_Batch/Rounds/prj-018_프라이머_배치/Project_정의.md` |
| `prj-content-os` | Content OS - MVP 개발 | active | `50_Projects/Content_OS/Rounds/prj-content-os/Project_정의.md` |
...
| `prj-n8n` | n8n Vault 자동화 | active | `50_Projects/Vault_System/Rounds/prj-n8n/Project_정의.md` |
| `prj-vault-gpt` | ChatGPT Vault MCP 연결 | doing | `50_Projects/Vault_System/Rounds/prj-vault-gpt/Project_정의.md` |
| `prj-yt-w33` | YouTube W33 | doing | `50_Projects/Youtube_Weekly/Rounds/prj-014_W33/Project_정의.md` |
...
| `tsk-002-05` | 꼭꼭 앱 1년 구독권 QA | todo | `50_Projects/2025/P002_[와디즈] 12주 코칭 습관팩 런칭/Tasks/꼭꼭 앱 1년 구독권 QA.md` |
| `tsk-002-06` | 꼭꼭FIT 음식편향테스트 특정 주차에 노출 | todo | `50_Projects/2025/P002_[와디즈] 12주 코칭 습관팩 런칭/Tasks/꼭꼭FIT 음식편향테스트 특정 주차에 노출.md` |
| `tsk-002-07` | 꼭꼭FIT+꼭꼭 앱 로그인 통합 | todo | `50_Projects/2025/P002_[와디즈] 12주 코칭 습관팩 런칭/Tasks/꼭꼭FIT+꼭꼭 앱 로그인 통합.md` |
...
| `tsk-008-01` | [단님] 후보 태스크 1 – 꼭꼭 앱 Onboarding UI/UX | doing | `50_Projects/2025/P008_파일럿 프로젝트 후보/Tasks/[단님] 후보 태스크 1 – 꼭꼭 앱 Onboarding UIUX.md` |
...
| `tsk-014-01` | 꼭꼭Fit 3기 환급 검토 | done | `50_Projects/2025/P014_코칭 운영 체계/Tasks/꼭꼭Fit 3기 환급 검토.md` |
| `tsk-014-02` | W33 대본작성 | done | `50_Projects/Youtube_Weekly/Rounds/prj-014_W33/Tasks/tsk-014-02_대본작성.md` |
| `tsk-014-03` | W33 촬영 | done | `50_Projects/Youtube_Weekly/Rounds/prj-014_W33/Tasks/tsk-014-03_촬영.md` |
...
| `tsk-017-04` | 사업계획서 작성 | done | `50_Projects/TIPS_Batch/Rounds/prj-017_아이디어파트너스_배치/Tasks/tsk-017-04_사업계획서작성.md` |
| `tsk-017-05` | 고객 관리 - 새해 인사 전달(유튜브, 오픈톡방, 꼭꼭Fit 참여인원 등) | doing | `50_Projects/2025/P012_[CS·운영] 고객관리대응/Tasks/고객_관리_새해_인사_전달유튜브_오픈톡방_꼭꼭Fit_참여인원_등.md` |
| `tsk-content-os-01` | Content OS - 프로젝트 초기 세팅 | done | `50_Projects/Content_OS/Rounds/prj-content-os/Tasks/Content OS - 프로젝트 초기 세팅.md` |
| `tsk-content-os-02` | Content OS - Opportunity 대시보드 UI | done | `50_Projects/Content_OS/Rounds/prj-content-os/Tasks/Content OS - Opportunity 대시보드 UI.md` |
| `tsk-content-os-03` | Content OS - Video Explorer UI | done | `50_Projects/Content_OS/Rounds/prj-content-os/Tasks/Content OS - Video Explorer UI.md` |
...
| `tsk-content-os-05` | Content OS - 회고 대시보드 UI | todo | `50_Projects/Content_OS/Rounds/prj-content-os/Tasks/Content OS - 회고 대시보드 UI.md` |
...
| `tsk-dashboard-ux-v1-04` | Quick Date Filter 초기화 버그 수정 | done | `50_Projects/Vault_System/Rounds/prj-dashboard-ux-v1/Tasks/tsk-dashboard-ux-v1-04_Quick_Date_Filter_초기화_버그_수정.md` |
| `tsk-dashboard-ux-v1-05` | Schema 상수 중앙화 | done | `50_Projects/Vault_System/Rounds/prj-dashboard-ux-v1/Tasks/tsk-dashboard-ux-v1-05_Schema_상수_중앙화.md` |
| `tsk-dashboard-ux-v1-06` | Dashboard Reset Filter 전체 초기화 | done | `50_Projects/Vault_System/Rounds/prj-dashboard-ux-v1/Tasks/tsk-dashboard-ux-v1-06_Dashboard_Reset_Filter_전체_초기화.md` |
| `tsk-dashboard-ux-v1-07` | validate_schema.py YAML 일원화 | done | `50_Projects/Vault_System/Rounds/prj-dashboard-ux-v1/Tasks/tsk-dashboard-ux-v1-07_validate_schema.py_YAML_일원화.md` |
| `tsk-dashboard-ux-v1-08` | build_graph_index.py YAML 일원화 | done | `50_Projects/Vault_System/Rounds/prj-dashboard-ux-v1/Tasks/tsk-dashboard-ux-v1-08_build_graph_index.py_YAML_일원화.md` |
| `tsk-dashboard-ux-v1-09` | loop-entity-creator 문서 수정 | done | `50_Projects/Vault_System/Rounds/prj-dashboard-ux-v1/Tasks/tsk-dashboard-ux-v1-09_loop-entity-creator_문서_수정.md` |
...
| `tsk-dashboard-ux-v1-17` | Dashboard - Google Calendar 연동 (읽기 전용) | doing | `50_Projects/Vault_System/Rounds/prj-dashboard-ux-v1/Tasks/tsk-dashboard-ux-v1-17_Dashboard_Google_Calendar_연동.md` |
...
| `tsk-impact-schema-v2-04` | Schema - Hypothesis validated_by 필드 마이그레이션 | done | `50_Projects/Vault_System/Rounds/prj-impact-schema-v2/Tasks/tsk-impact-v2-03_validated_by_마이그레이션.md` |
| `tsk-impact-schema-v2-05` | Schema - Derived 필드 롤업 로직 완성 | doing | `50_Projects/Vault_System/Rounds/prj-impact-schema-v2/Tasks/tsk-impact-v2-02_Derived_롤업_로직.md` |
| `tsk-impact-v2-06` | Evidence - 품질 메타 표준화 + 승인 로그 구현 | done | `50_Projects/Vault_System/Rounds/prj-impact-schema-v2/Tasks/tsk-impact-v2-06_Evidence_품질메타_승인로그.md` |
...
| `tsk-mcp-rbac-03` | MCP - loop_exec Vault 라우팅 구현 | doing | `50_Projects/Vault_System/Rounds/prj-mcp-dual-vault-rbac/Tasks/tsk-mcp-rbac-03_loop_exec_Vault_라우팅.md` |
| `tsk-n8n-01` | n8n Docker 배포 및 파이프라인 구축 | done | `50_Projects/Vault_System/Rounds/prj-n8n/Tasks/tsk-n8n-01_n8n_Docker_배포_파이프라인.md` |
| `tsk-n8n-02` | n8n 자동화 워크플로우 구축 | done | `50_Projects/Vault_System/Rounds/prj-n8n/Tasks/tsk-n8n-02_n8n_자동화_워크플로우_구축.md` |
| `tsk-n8n-03` | n8n - Project Impact Score 자동화 n8n 워크플로우 | done | `50_Projects/Vault_System/Rounds/prj-n8n/Tasks/tsk-n8n-03_Project_Impact_Score_자동화_워크플로우.md` |
...
| `tsk-n8n-08` | n8n - Workflow v4 구현 및 E2E 테스트 | done | `50_Projects/Vault_System/Rounds/prj-n8n/Tasks/tsk-n8n-08_Workflow_v4_구현_및_E2E_테스트.md` |
| `tsk-n8n-09` | n8n - Phase 1/2 AI Router 통합 | done | `50_Projects/Vault_System/Rounds/prj-n8n/Tasks/tsk-n8n-09_Phase_1_2_AI_Router_통합.md` |
| `tsk-n8n-10` | Dashboard - Pending Reviews 3단 레이아웃 UX 개선 | done | `50_Projects/Vault_System/Rounds/prj-n8n/Tasks/tsk-n8n-10_Dashboard_Pending_Reviews_3단_레이아웃_UX_개선.md` |
| `tsk-n8n-11` | Hypothesis - Seeder 워크플로우 API 개발 | doing | `50_Projects/Vault_System/Rounds/prj-n8n/Tasks/tsk-n8n-11_Hypothesis_Seeder_워크플로우_API_개발.md` |
| `tsk-n8n-12` | Evidence 자동화 - 운영 완성 (Workflow C + Server Skip) | done | `50_Projects/Vault_System/Rounds/prj-n8n/Tasks/tsk-n8n-12_Evidence_자동화_운영_완성.md` |
| `tsk-n8n-13` | Dashboard - Pending Reviews 필드 선택 UX 개선 | doing | `50_Projects/Vault_System/Rounds/prj-n8n/Tasks/tsk-n8n-13_Dashboard_Pending_Reviews_필드_선택_UX_개선.md` |
...
| `hyp-6-01` | 전면 유료화 성립 | todo | `60_Hypotheses/2026/hyp-6-01_전면유료화_성립.md` |
| `hyp-6-02` | 전환율 최소선 | todo | `60_Hypotheses/2026/hyp-6-02_전환율_최소선.md` |
| `hyp-6-03` | 환불/클레임 통제 | todo | `60_Hypotheses/2026/hyp-6-03_환불_클레임_통제.md` |
| `hyp-6-04` | 가격·플랜 최적 조합 존재 | todo | `60_Hypotheses/2026/hyp-6-04_가격_플랜_최적조합.md` |
