...
graph TD
    ...
    Focus1[Focus 1<br/>GLP-1 언어 30개]
    Focus2[Focus 2<br/>콘텐츠 50개]
    Focus3[Focus 3<br/>Loop Index 교육]
    Focus4[Focus 4<br/>멀티 채널]

    Track3 -->|contains| Focus1
    Track3 -->|contains| Focus2
    Track3 -->|contains| Focus3
    Track3 -->|contains| Focus4

    Track3 -->|자연 유입| Track6
    Track3 -->|인지도| Track1

    Track3 -.->|if fail| HighCAC[광고 의존도 증가]
```
